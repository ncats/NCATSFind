                        ...
                        if(!Zepto(this).hasClass("unii")){
                            ...
                            if(str==undefined){
                                ...
                                if(GM_xmlhttpRequest==undefined ){
                                    ...
                                    xhr.open("GET", "https://tripod.nih.gov/servlet/resolver/?structure=" + encodeURIComponent(uniilook).replace("+","%2B"), true);
                                    xhr.onreadystatechange = function() {
                                      if (xhr.readyState == 4) {
                                         lookup[uniilook]=xhr.responseText.split("\t")[1];
                                    ...
                                    GM_xmlhttpRequest({
                                      method: "GET",
                                      url: "https://tripod.nih.gov/servlet/resolver/?structure=" + encodeURIComponent(uniilook).replace("+","%2B"),
                                      onload: function(response) {
                                          lookup[uniilook]=response.responseText.split("\t")[1];
                                          //alert(lookup[uniilook]);
...
function urlFor(str){
	return "https://tripod.nih.gov/servlet/renderServletv7/?structure=" + encodeURIComponent(str) + "&format=svg&rotate=0.0";
}
function hide(){
...
function takeSnap(callback) {
    ...
    document.getElementById("myrect").style.zIndex = 1000;
    document.getElementById("mycoord").style.zIndex = 1001;
}
