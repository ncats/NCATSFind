        ...
        if(element.textContent !=undefined){
            ...
            if(matchAny(element.textContent,regexSet) || UNIIS.length>0){
                ...
                if (str != ostr) {
                    ...
                    $('.ncgchover .ncatsterm').css("background-color", "rgba(0, 51, 255, 0.2)");
...
function tutorialOverlay(callback){
	...
	var eventAdded=function (e) {
        ...
        var styleov = 'border:none;cursor:crosshair;width: 100%;height: 100%;position: absolute;top: 0px;left: 0px;background: rgba(0, 0, 0, 0.25);    font-size: 20pt;    color: white;    /* display: none; */    z-index: 999999 !important;    text-align: center;    position: fixed;';
        var styleov2 = 'border:none;cursor:crosshair;width: 0;height: 0;position: absolute;top: 0px;left: 0px;background: rgba(0, 0, 0, 0.25);    font-size: 20pt;    color: white;    /* display: none; */    z-index: 999999 !important;    text-align: center;    position: fixed;';
        ...
        econt.innerHTML += "<div id='myrect' style='margin:0;font-size: 12pt;-webkit-box-sizing: initial;background:none;cursor:move;position:fixed;border:1px dashed black;top:0px;left:0px;width:0px;height:0px'>" +
            "<div style='padding:5px;border-radius:0px;position:absolute;background:rgb(76, 126, 231);color:white;top:-29px;left:0px;height:19px;overflow:hidden;'>" + title + "</div>" +
        //resizeDiv1+
        //resizeDiv2+
        //resizeDiv3+
        resizeDiv4 + okbutton + cancelbutton + "</div>";
